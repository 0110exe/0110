...
_G.Key = "IOAEUFIEFOUFJEF0OPEIP"

local keys = {
    "IOAEUFIEFOUFJEF0OPEIP",
    "Dont_Use_This!",
}
...
if game.PlaceId == 2788229376 then
    ...
    Players.PlayerAdded:Connect(function(player)
        game.StarterGui:SetCore("SendNotification", {
            Title = "Hm.. It seems like someone joined!",
                            ...
                            if getgenv().isDropping == false then
                                ...
                                while getgenv().isDropping == true do
                                    ...
                                    if game:GetService("Players").LocalPlayer.DataFolder.Currency.Value < 10000 then
                                        local args = {
                                            [1] = "Hmm... It seems ive become broke!",
                                            [2] = "All"
                                        }
    ...
    if game.Players.LocalPlayer.UserId == getgenv().controller then
        ...
        Rank_17.Text =
            "This script has been made by Kay xox"
